...
export function DashboardLinkCard({ username, paymentLink }: DashboardLinkCardProps) {
  ...
  const shareLink = async () => {
    // If the browser supports native share, try it. 
    // Wait, on desktop sometimes native share throws, so we just use the new ShareModal
    // Let's just always open the custom ShareModal, as it has QR and looks great.
